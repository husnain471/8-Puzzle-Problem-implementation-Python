...
if __name__=='__main__':
    ...
    print("------------DFS has started execution------------")
    timeTakenDFS, pathDFS = dfs(initialState, goalState)
    print("Time taken by DFS : " + str(timeTakenDFS/60) + " minutes")